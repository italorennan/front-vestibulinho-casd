...
const infosCourse = [
  {
    "casdvest": {
      ...
      infoText: 
      <>
        <p>Este é o formulário de inscrição para o <span>Processo Seletivo de Alunos do CASDvest</span> para o ano de <span>2021</span>. Para completar a inscrição, é <span>necessário preencher este formulário até o fim</span>.</p>
        <p>O CASDvest é um curso pré-vestibular de caráter assistencialista, voltado à preparação para vestibulares como a FUVEST, UNICAMP, UNESP e o ENEM. Oferecemos ensino gratuito para jovens em situação de vulnerabilidade socioeconômica na região do Vale do Paraíba. Se você é formado no Ensino Médio ou cursará o 3º ano do Ensino Médio em 2021, não deixe de se inscrever!</p>,
    ...
    "casdinho": {
      infoTitle: "Inscrições Vestibulinho CASDinho 2020",
      infoText: 
      <>
        <p>Este é o formulário de inscrição para o <span>Processo Seletivo de Alunos do CASDinho</span> para o ano de <span>2021</span>. Para completar a inscrição, é <span>necessário preencher este formulário até o fim</span>.</p>
        <p>O CASDinho é um curso de caráter assistencialista, voltado à preparação para os concursos e escolas de Ensino Médio de qualidade, como o Colégio Embraer Juarez Wanderley e a ETEC. Oferecemos ensino gratuito para jovens em situação de vulnerabilidade socioeconômica na região do Vale do Paraíba. Se você cursará o 8º ou 9º ano do Ensino Fundamental em 2021, não deixe de se inscrever!</p>,
